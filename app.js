...
const budgetController = (function(){
    ...
    return {
        addItem: function(type, des, val){
            ...
            // Push New Item to approiate array
        ...
        calculateBudget: function(){
            ...
            /// calculate percent of income we spent 
...
const UIController = (function(){
    ...
    return {
        ...
        addListItem: function(obj, type){
            ...
            html = '<div class="item clearfix" id="exp-%id%"><div class="item__description">%description%</div><div class="right clearfix"><div class="item__value">%value%</div> <div class="item__percentage">21%</div><div class="item__delete"><button class="item__delete--btn"><i class="ion-ios-close-outline"></i></butto></div></div></div>';
            }
